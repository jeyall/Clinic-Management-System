Public Class info
    Private Sub info_Load(sender As Object, e As EventArgs) Handles Me.Load
        'TODO: This line of code loads data into the 'Db_cygnetmedDataSet.tb_logs' table. You can move, or remove it, as needed.
        Me.Tb_logsTableAdapter.Fill(Me.Db_cygnetmedDataSet.tb_logs)
        ...
        mtab_info.SelectedTab = mtab_register
    End Sub
    ...
    Private Sub mtile_refresh_Click(sender As Object, e As EventArgs) Handles mtile_refresh.Click
        Tab_register1.tab_register_Load(sender, e)
        Info_tab_records1.info_tab_records_Load(sender, e)
    End Sub
End Class